...
def test_ip_check_uses_clipboard_when_ip_omitted(monkeypatch):
    ...
    class FakeClient:
        ...
        def get(self, url: str, params: dict | None = None):
            ...
            return _FakeResponse({"scamalytics": {"ip": "8.8.8.8", "scamalytics_score": 0, "scamalytics_risk": "low"}, "external_datasources": {}})

    monkeypatch.setenv("SCAMALYTICS_API_KEY", "https://api11.scamalytics.com/v3/testuser/?key=test-key")
